...
* **Caution**. Choose a reaction. Once, during the encounter, you may perform that reaction without counting against your reaction for the round.
* **Ferocity**. When you have advantage on an attack, you may replace the advantage gained on an attack with getting a bonus equal to your heroism for the purpose of determining if it is a critical hit.
...
If you have expertise with a weapon, you gain an additional +1 to attacks and beats with that weapon.
...
#### Splash
If you splash warrior as a member of another class, you gain the ability to gain the warrior's training just like a warrior.  
If you have specialization or expertise with a weapon, you may train a further level with that weapon to acquire "Warrior Mastery" with that weapon. Doing so enables a benefit unique to that weapon (see table below). You do not need expertise with the weapon to achieve this. 
Additionally, you gain training with a number of weapons equal to your current level. Anytime you gain a new level, you gain training in a weapon of your choice.
...
| Warpick                | If you damage the foe's armor or inflict a critical hit, you may have the weapon get stuck in the foe- causing it to suffer a -2 penalty to all checks and a -1 penalty to Attack Rolls and Saves until it is removed with a [Body] Check of 12. Against an unarmord foe, you instead inflict an additional hemorrhage. Gains a +1 to sunder based attack rolls.|
|                        |           |
