...
### Acolyte
You learn a language of your choice. Additionally, you learn 2 languages of your choice. You may replace either or both of these with training in a weapon of your choice (must be different weapons if both). You learn 2 rites of your choice (see the Liturgy feature below).
...
### 4) Chalogesis
When you succeed a counterspell check against a creature casting a spell, you may choose to reduce the tier of the spell in place of increasing the casting time by half, if it is cast above minimum tier. You make this decision when you succeed. If it is not cast above minimum tier, it will apply the standard counterspell check effect.
