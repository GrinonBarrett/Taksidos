...
Anytime the weapon is cranked and fired, there is a 1 in 20 chance the mechanism will fail- rendering it useless (let the player choose a number when making their attack roll).
