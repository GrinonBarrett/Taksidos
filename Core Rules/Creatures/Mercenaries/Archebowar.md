### Archebowar
These elite soldiers have been trained since boyhood to use the longbow.

**Creature Type**: Archebowars are humanoids, though could hypothetically be members of another type (see below) are Humanoids.

**Size**: Archebowars are between 4.5-6 feet tall. They can weigh between 120 and 185 pounds. They are medium creatures.

**Hitpoints**: An archebowar has no hitpoints.
...
**Languages**: Archebowars often speak the Common Tongue and one other.

**Run Speed**: It may run up to 5 yards per move.

**Swim speed**: It may swim up to 2 yards per move, presuming the water isn’t too rough.

**Weapon Attacks**: The archebowar is capable of using weapons. It even has expertise in bows, specialization in maces, and proficiency in another weapon.

**Defenses**: An archebowar can use armor and a shield. It uses the standard attack chart as appropriate to its armor and/or shield.

**Unarmed Attacks**;

 • Unarmed Strike: The archebowar may use part of its body to strike a foe within 1 foot. This is a melee bare attack.
...
#### Archebowars of Other Species'
An archebowar of a species other than manfolk should have their attributes, size, unarmed attacks, and creature type adjusted appropriately- however infigura, ephemera, beasts, and any species with a feature which includes the word "nature" in it should be excluded as these can complicate things a bit. Such an archebowar still eats, drinks, breathes, etc. as a normal member of that species.
