...
**Size**: A warwyf between 4.5-5.5 feet tall. They can weigh between 100 and 150 pounds. They are medium creatures.

**Hitpoints**: A warwyf has a single hitpoint.
...
**Languages**: Warwyfes often speak the Common Tongue and Emerian.

**Run Speed**: She may run up to 5 yards per move.

**Swim speed**: She may swim up to 2 yards per move, presuming the water isn’t too rough.

**Weapon Attacks**: The warwyf is capable of using weapons. It even has proficiency in three weapons. Common weapons include longsword, dagger, pike, and spear.

**Defenses**: A warwyf can use armor and a shield. She uses the standard attack chart as appropriate to her armor and/or shield.

**Unarmed Attacks**;

 • Unarmed Strike: The warwyf may use part of her body to strike a foe within 1 foot. This is a melee bare attack.
