### Alderalv
Elves of the realm known as the Alnuskogs. They are the keepers and defenders of the realm. They can be reasoned with to barter for passage through their domain to another land, but will take any unannounced entry as a hostile action. They prefer to fight hidden and with great mobility. The plural is Alderolves. Their collective noun is a Skogurn.

**Creature Type**: Alderolves are Sylvan.

**Size**: Alderolves stand between 4' and 5' tall. They can weigh between 110-130 pounds. They are medium creatures.

**Hitpoints**: Alderolves have a single Hitpoint.
...
**Languages**: Alderolves speak their own langugage and the wild tongue.
...
**Weapon Attacks**: The alderalv is capable of using weapons. It even has proficiency in clubs and three other weapons (usually among bows, hand axes, javelins, slings, and spears).

**Defenses**: An alderalv can, hypothetically, use armor and a shield. They are seldom to as such items are rare for them, and their lifestyle typically does not demand it.

**Unarmed Attacks**;

 • Unarmed Strike: The alderalv may use part of its body to strike a foe within 1 foot. This is a melee bare attack.
