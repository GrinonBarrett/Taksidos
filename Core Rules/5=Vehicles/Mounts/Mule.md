...
**Hitpoints**: A mule has 1 hitpoint.
...
**Weight Load Limits**;  
* Light: 20% mule's wieght.
* Moderate: 10 + ([Body] score)% of mule's weight.
* Heavy: Double ([Body] score)% of mule's weight.
